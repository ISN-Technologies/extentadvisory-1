        ...
        <div class="col-lg-4 col-md-7 col-sm-9 order-lg-1 order-2">
          <div class="service-sidebar mt-30">
            <div class="service-sidebar-list">
              <ul>
                <li><nuxt-link to="/">Logistics</nuxt-link></li>
                <li><nuxt-link to="/">Construction Material Supply </nuxt-link></li>
                <li><nuxt-link to="/">Real Estate</nuxt-link></li>
                <li><nuxt-link to="/">Mining</nuxt-link></li>
                <li><nuxt-link to="/">Software Solutions</nuxt-link></li>
                <li><nuxt-link to="/">Professional Consultancy</nuxt-link></li>
              </ul>
            </div>
        ...
        <div class="col-lg-8 order-lg-2 order-1">
          <div class="single-project mt-30">
            <div class="single-project-thumb">
              <img src="/assets/images/770%20-%20ultrasonic%20header.png" alt="">
            </div>
            ...
            <div class="single-project-text">
              ...
              <a class="main-btn mt-55" href="#">Download the Documentation</a>
            </div>
          </div>
        </div>
      </div>

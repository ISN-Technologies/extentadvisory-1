        ...
        <div class="row">
          <div class=" col-lg-4 col-xl-2">
            <div class="project-content">
              <h3 class="title">Explore <br> our  <br> products</h3>
              <p>Our engineering team has developed the following solutions to meet your business needs.</p>
            </div>
              ...
              <swiper :options="swiperOptions">
                <swiper-slide>
                  <div class="project-item">
                    ...
                    <a href="#">Smart Water Meters</a>
                  </div>
                </swiper-slide>
                <swiper-slide>
                  <div class="project-item">
                    <img src="/assets/images/project-item-2.jpg" alt="">
                    <a href="#">Smart Electric Meters</a>
                  </div>
                </swiper-slide>
                <swiper-slide>
                  <div class="project-item">
                    <img src="/assets/images/project-item-3.jpg" alt="">
                    <a href="#">Gama Server</a>
                  </div>
                </swiper-slide>
                <swiper-slide>
                  <div class="project-item">
                    <img src="/assets/images/project-item-1.jpg" alt="">
                    <a href="#">Gama Smart TV</a>
                  </div>
                </swiper-slide>
                <swiper-slide>
                  <div class="project-item">
                    <img src="/assets/images/project-item-2.jpg" alt="">
                    <a href="#">All in One Deskstar</a>
                  </div>
                </swiper-slide>
              </swiper>
            </div>

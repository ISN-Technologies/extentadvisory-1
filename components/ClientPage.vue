            ...
            <swiper-slide>
              <div class="client-item mt-30">
                ...
                <div class="user">
                  ...
                  <h5 class="title">Salum Haji</h5>
                  <span>manager | zawa</span>
                </div>
                <div class="text">
                  <p>Ever since we started using Gama Smart Water Meters we've experienced boost in sales and revenue collection. The devices have proved to be far way effective than we anticipated. </p>
                </div>
              </div>
            </swiper-slide>
            <swiper-slide>
